...
icon: house
title: 河海大学智泽实验室
heroImage: /images/zhizelab_logo.png
bgImage: images/dark-in-main.jpg
bgImageDark: images/main3.jpg
bgImageStyle:
  background-attachment: fixed
heroFullScreen: true
heroText: 河海大学智泽实验室
tagline: ⼈⼯智能+产业融合升级的⻅证者、实践者、推动者
actions:
  - text: 关于我们
    icon: lightbulb
    link: ./demo/
...
copyright: false
footer: 使用 <a href="https://theme-hope.vuejs.press/zh/" target="_blank">VuePress Theme Hope</a> 主题 | MIT 协议, 版权所有 © 2025-至今 河海大学智泽实验室
---
<!-- 
